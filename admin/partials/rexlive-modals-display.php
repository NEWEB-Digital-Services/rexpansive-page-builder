...
<div class="rex-modal-wrap">
    <div id="rexlive-onbeforeunload" class="rex-modal rexbuilder-materialize-wrap rex-modal-draggable">
        ...
        <div class="modal-content modal-content--text">
            <div class="layout-page-changed-description">
                <b><?php _e( 'ATTENZIONE', 'rexpansive-builder' ); ?></b><br>
                Prima di chiudere la scheda in corso/prima di cambiare pagina verifica di aver salvato il tuo progetto.
            </div>
        </div>
        <div class="rex-modal__outside-footer">
...
<div class="rex-modal-wrap">
    <div id="rex-button-editor" class="rex-modal rexbuilder-materialize-wrap rex-modal-draggable setting-edited">
        <!-- Pulsante per la chiusura del popup -->
        <div class="tool-button tool-button--black rex-cancel-button tool-button--close tippy" data-tippy-content="Cancel" value="" tabindex="0">
            <span class="rex-button"><?php Rexbuilder_Utilities::get_icon('#Z003-Close'); ?></span>
        </div>
                ...
                <div class="rexbutton-cont_row23">
                    ...
                    <div class="rexbutton-count-column_7 nobord"><!-- BORDER RADIUS -->
                        <div class="rexbutton-count-column_container">
                            ...
                            <div class="subRow7_2 tippy" data-tippy-content="<?php _e( 'Border Radius', 'rexpansive' ); ?>">
                    ...
                    <div class="rexbutton-count-column_7"><!-- HEIGHT -->
                        <div class="rexbutton-count-column_container">
                            ...
                            <div class="subRow7_2 tippy" data-tippy-content="<?php _e( 'Button Height', 'rexpansive' ); ?>">
                    ...
                    <div class="rexbutton-count-column_7"><!-- WIDTH -->
                        <div class="rexbutton-count-column_container">
                            ...
                            <div class="subRow7_2 tippy" data-tippy-content="<?php _e( 'Button Width', 'rexpansive' ); ?>">
