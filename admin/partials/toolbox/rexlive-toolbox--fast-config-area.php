...
<div class="bl_d-iflex bl_ai-c toolbox-right-fast-config-area toolbox-config-area">
  <div class="tool-button--double-icon--wrap tippy" data-tippy-content="<?php _e('Background Image','rexpansive-builder'); ?>">
  ...
  <div class="tool-button--double-icon--wrap tool-button--opacity-preview tippy" data-tippy-content="<?php _e('Overlay','rexpansive-builder'); ?>">
  ...
  <div class="tool-button--double-icon--wrap tippy" data-tippy-content="<?php _e('Background Video','rexpansive-builder'); ?>">
