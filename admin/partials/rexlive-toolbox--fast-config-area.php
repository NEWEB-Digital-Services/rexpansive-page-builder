...
<div class="bl_d-iflex bl_ai-c toolbox-right-fast-config-area toolbox-config-area">
  <div class="tool-button--double-icon--wrap tippy" data-tippy-content="<?php _e('Background Image','rexpansive'); ?>">
  ...
  <div class="tool-button--double-icon--wrap tippy" data-tippy-content="<?php _e('Background Video','rexpansive'); ?>">
