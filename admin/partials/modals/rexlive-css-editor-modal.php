...
<div class="rex-modal-wrap">
    <div id="rex-css-editor" class="rexbuilder-materialize-wrap rex-modal rex-modal-draggable setting-edited">
        ...
        <div class="rex-modal__outside-footer">
            <div id="css-editor-save" class="tool-button tool-button--inline tool-button--confirm tool-button--modal rex-save-button tippy" data-tippy-content="<?php esc_attr_e( 'Save', 'rexpansive-builder' ); ?>">
