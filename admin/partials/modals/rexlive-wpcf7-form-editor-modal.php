            ...
            <div class="rexpansive-accordion-outer close"> <!-- // Form Accordion -->
                <div class="bl_modal-row">
                    <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                        <div class="bl_d-iblock rex-wpcf7-modal-column-w50">
                            <span class="rex-accordion--toggle">
                                <?php Rexbuilder_Utilities::get_icon('#Z003-Close'); ?>
                            </span>
                        </div>
                        <div class="bl_d-iblock rex-wpcf7-modal-column-w50 modal-accordion-title">form</div>
                    </div>
                </div>
                <div class="rex-accordion--content" style="display:none;" data-item-status="close">
                    ...
                    <div class="bl_modal-row"> <!-- // Form Background Color, Form Border Color -->
                        <div class="bl_modal__option-wrap bl_jc-c">
                            <div id="" class="bl_modal__single-option valign-wrapper tippy" data-tippy-content="<?php _e('Background Color', 'rexpansive-builder');?>">
                                ...
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w50"  tabindex="0">
                        ...
                        <div class="bl_modal__option-wrap bl_jc-c valign-wrapper">
                            <div id="" class="bl_modal__single-option valign-wrapper">
                                <span class="valign-wrapper tippy" data-tippy-content="<?php _e('Border Color', 'rexpansive-builder');?>">
                                    <div class="bl_d-iblock form-icon l-icon--dark-grey"> <!-- // 39px -->
                                ...
                                <span class="rex-wpcf7-modal-column-w50 valign-wrapper tippy" data-tippy-content="<?php _e('Border Width', 'rexpansive-builder');?>">
                    ...
                    <div class="bl_modal-row"> <!-- // Error Message -->
                        <div class="rexwpcf7-cont_row valign-wrapper">
                            <div class="bl_d-iblock rex-wpcf7-modal-column-w50 big-icon l-icon--dark-grey">
                                <?php Rexbuilder_Utilities::get_icon('#B019-Error'); ?>
                            </div>
                            <div class="bl_d-iblock rex-wpcf7-modal-column-w200 with-text">
                                <input type="text" id="rex-wpcf7-error-message" name="" class="rex-wpcf7-error-message" placeholder="Error Message">
                            </div>
                            <div class="bl_d-iblock rex-wpcf7-modal-column-w50 tippy" data-tippy-content="<?php _e('Color', 'rexpansive-builder');?>" tabindex="0">
                            ...
                            <div class="bl_d-iblock rex-wpcf7-modal-column-w70 with-text">
                    ...
                    <div class="bl_modal-row"> <!-- // Send Message -->
                        <div class="rexwpcf7-cont_row valign-wrapper">
                            <div class="bl_d-iblock rex-wpcf7-modal-column-w50 big-icon l-icon--dark-grey">
            ...
            <div class="rexpansive-accordion-outer close"> <!-- // Inputs Accordion -->
                <div class="bl_modal-row">
                    <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                        ...
                        <div class="bl_d-iblock rex-wpcf7-modal-column-w50 modal-accordion-title">inputs</div>
                    </div>
                </div>
                <div class="rex-accordion--content" style="display:none;" data-item-status="close">
                    <div class="bl-modal-row"> <!-- // Content Preview -->
                        <div class="bl_modal-row bl_jc-c"> 
                            <div class="bl_d-iblock with-preview-text">
                    ...
                    <div class="bl_modal-row"> <!-- // Columns Width, Columns Height -->
                        <div class="bl_modal__option-wrap bl_jc-c tippy" data-tippy-content="<?php _e('Columns Width', 'rexpansive-builder');?>">
                            <div class="rex-input-prefixed with-text pr12" >
                        ...
                        <div class="bl_modal__option-wrap bl_jc-c tippy" data-tippy-content="<?php _e('Columns Height', 'rexpansive-builder');?>">
                            <div class="rex-input-prefixed with-text pr12">
                                <span class="prefix pr12">
                    ...
                    <div class="rexpansive-accordion close"> <!-- // Content Text Color -->
                        <div class="bl_modal-row">
                            <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                                ...
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w50 tippy" tabindex="0" data-tippy-content="<?php _e('Text Color', 'rexpansive-builder');?>">
                                ...
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w50 with-text tippy" data-tippy-content="<?php _e('Font Size', 'rexpansive-builder');?>">
                        ...
                        <div class="rex-accordion--content" style="display:none;" data-item-status="close"> <!-- // Content Text Color Hover -->
                            <div class="bl_modal-row">
                                <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                                    <div class="bl_d-iblock rex-wpcf7-modal-column-w50"></div>
                                    <div class="bl_d-iblock rex-wpcf7-modal-column-w50 big-icon l-icon--dark-grey">
                                        <?php Rexbuilder_Utilities::get_icon('#B024-Input-Text-Hover'); ?>
                                    </div>
                                    <div class="bl_d-iblock rex-wpcf7-modal-column-w50 tippy" tabindex="0" data-tippy-content="<?php _e('Hover Text Color', 'rexpansive-builder');?>">
                                    ...
                                    <div id="hover-text-color-palette" class="clearfix">
                    ...
                    <div class="rexpansive-accordion close"> <!-- // Content Background Color -->
                        <div class="bl_modal-row">
                            <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                                ...
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w50 tippy" tabindex="0" data-tippy-content="<?php _e('Background Color', 'rexpansive-builder');?>">
                                ...
                                <div id="background-color-palette" class="clearfix">
                                    <div class="bg-palette-selector">
                                        <input class="bg-palette-value" type="hidden" value="rgba(33,150,243,1)">
                                        <span class="bg-palette-button bg-palette-blue"></span>
                                    </div>
                        ...
                        <div class="rex-accordion--content" style="display:none;" data-item-status="close"> <!-- // Content Background Color Hover -->
                            <div class="bl_modal-row">
                                <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                                    ...
                                    <div class="bl_d-iblock rex-wpcf7-modal-column-w50 tippy" tabindex="0" data-tippy-content="<?php _e('Hover Background Color', 'rexpansive-builder');?>">
                                    ...
                                    <div id="hover-background-color-palette" class="clearfix">
                                        <div class="bg-palette-selector">
                                            <input class="bg-palette-value" type="hidden" value="rgba(33,150,243,1)">
                                            <span class="bg-palette-button bg-palette-blue"></span>
                                        </div>
                    ...
                    <div class="rexpansive-accordion close"> <!-- // Content Border Color -->
                        <div class="bl_modal-row">
                            <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w50">
                                    <span class="rex-accordion--toggle">
                                ...
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w50 tippy" tabindex="0" data-tippy-content="<?php _e('Border Color', 'rexpansive-builder');?>">
                                ...
                                <!-- <div class="bl_d-iblock rex-wpcf7-modal-column-w50 l-icon--dark-grey l-icon--rotate-90"></div> -->
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w70 with-text tippy" data-tippy-content="<?php _e('Border Width', 'rexpansive-builder');?>">
                                    <span class="bl_d-iblock l-icon--dark-grey l-icon--rotate-90"><?php Rexbuilder_Utilities::get_icon('#B007-Move'); ?></span>
                                    <input type="text" id="rex-wpcf7-set-content-border-width" name="" class="rex-wpcf7-set-content-border-width bl_d-iblock ">
                                    <div class="label-px bl_d-iblock">px</div>
                                </div>
                                <!-- <div class="bl_d-iblock rex-wpcf7-modal-column-w50 l-icon--dark-grey"></div> -->
                                <div class="bl_d-iblock rex-wpcf7-modal-column-w70 with-text tippy" data-tippy-content="<?php _e('Border Radius', 'rexpansive-builder');?>">
                                    <span class="bl_d-iblock l-icon--dark-grey"><?php Rexbuilder_Utilities::get_icon('#D001-Radius'); ?></span>
                                    <input type="text" id="rex-wpcf7-set-content-border-radius" name="" class="rex-wpcf7-set-content-border-radius bl_d-iblock ">
                                    <div class="label-px bl_d-iblock">px</div>
                                </div>
                            </div>
                        </div>
                        <div class="rex-accordion--content" style="display:none;" data-item-status="close"> <!-- // Content Border Color Hover -->
                            <div class="bl_modal-row">
                                <div class="rexwpcf7-cont_row bl_ai-c valign-wrapper">
                                    ...
                                    <div class="bl_d-iblock rex-wpcf7-modal-column-w50 tippy" tabindex="0" data-tippy-content="<?php _e('Hover Border Color', 'rexpansive-builder');?>">
                                    ...
                                    <div id="hover-border-color-palette" class="clearfix">
                                        <div class="bg-palette-selector">
                                            <input class="bg-palette-value" type="hidden" value="rgba(33,150,243,1)">
                                            <span class="bg-palette-button bg-palette-blue"></span>
                                        </div>
