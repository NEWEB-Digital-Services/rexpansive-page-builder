...
<div class="rexlive-responsive-toolbox">
    <button class = "builder-mobile-layout" style="position:absolute;bottom:0px;left:0%;">Mobile</button>
    <button class = "builder-tablet-layout" style="position:absolute;bottom:0px;left:25%;">Tablet</button>
    <button class = "builder-desktop-layout" style="position:absolute;bottom:0px;left:50%;">Desktop</button>
    <button class = "builder-my-desktop-layout" style="position:absolute;bottom:0px;left:75%;">My Desktop</button>
