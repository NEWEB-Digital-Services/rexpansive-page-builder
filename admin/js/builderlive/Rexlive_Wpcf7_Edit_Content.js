...
var Wpcf7_Edit_Content_Modal = (function ($) {
    ...
    var _openColumnContentEditorModal = function (data) {
        ...
        switch(inputType) {
            case "text":
                wpcf7_content_editor_properties.$content_required_field.parents(".bl_modal__option-wrap").removeClass("row-hidden");
            ...
            case "number":
                ...
                break;
            case "textarea":
                wpcf7_content_editor_properties.$content_required_field.parents(".bl_modal__option-wrap").removeClass("row-hidden").addClass('no-br');
                wpcf7_content_editor_properties.$content_required_field.parents(".bl_modal-row").removeClass("row-hidden");
                wpcf7_content_editor_properties.$content_placeholder.parents(".bl_modal-row").removeClass("row-hidden");
                wpcf7_content_editor_properties.$content_input_width.parents(".bl_modal-row").removeClass("row-hidden");
                wpcf7_content_editor_properties.$content_input_width_type.parents(".bl_modal-row").removeClass("row-hidden");
            ...
            case "select":
                ...
                wpcf7_content_editor_properties.$content_select_color_after_selection_value.parents(".bl_modal-row").removeClass("row-hidden");
            ...
            case "radio":
                ...
                wpcf7_content_editor_properties.$content_input_height_type.parents(".bl_modal-row").removeClass("row-hidden");
                wpcf7_content_editor_properties.$content_input_height.parents(".bl_modal__option-wrap").removeClass("row-hidden");
                wpcf7_content_editor_properties.$content_text_color_value.parents(".bl_modal-row").find('.rex-wpcf7-accordion-plus-wrap').css('visibility', 'hidden');
                wpcf7_content_editor_properties.$content_text_color_value.parents(".bl_modal-row").removeClass("row-hidden");
                wpcf7_content_editor_properties.$content_text_color_value.parents(".rexwpcf7-cont_row").append(fontSizeField);
                wpcf7_content_editor_properties.$content_text_color_focus_value.parents(".bl_modal-row").removeClass("row-hidden");
                wpcf7_content_editor_properties.$field_list.removeClass("row-hidden");
            ...
            case "file":
                ...
                wpcf7_content_editor_properties.$self.find('.accotdion-button-title').parents('.bl_modal-row').removeClass('row-hidden');
    ...
    var _updatePanel = function () {
        ...
        wpcf7_content_editor_properties.$content_preview_select_after_selection.css("background-color", columnContentData.select_color_after_selection);
        wpcf7_content_editor_properties.$content_select_color_after_selection_value.val(columnContentData.select_color_after_selection);
        wpcf7_content_editor_properties.$content_select_color_after_selection_preview.hide();
        wpcf7_content_editor_properties.$content_select_color_after_selection_value.spectrum("set", columnContentData.select_color_after_selection);

        // Placeholder color
        wpcf7_content_editor_properties.$content_preview_placeholder.css("background-color", columnContentData.placeholder_color);
        ...
        wpcf7_content_editor_properties.$content_placeholder_color_value.spectrum("set", columnContentData.placeholder_color);

        // Placeholder hover color
        wpcf7_content_editor_properties.$content_preview_placeholder_hover.css("background-color", columnContentData.placeholder_hover_color);
        wpcf7_content_editor_properties.$content_placeholder_hover_color_value.val(columnContentData.placeholder_hover_color);
        wpcf7_content_editor_properties.$content_placeholder_hover_color_preview.hide();
        wpcf7_content_editor_properties.$content_placeholder_hover_color_value.spectrum("set", columnContentData.placeholder_hover_color);
        ...
        wpcf7_content_editor_properties.$button_preview.hover(function() {
            $(this).css({
    ...
    var _linkSelectTextColorEditor = function () {
        ...
        wpcf7_content_editor_properties.$content_select_color_preview.on(
            "click",
            function () {
    ...
    var _linkSelectTextColorAfterSelectionEditor = function () {
        ...
        wpcf7_content_editor_properties.$content_select_color_after_selection_preview.on(
            "click",
            function () {
    ...
    var _linkPlaceholderColorEditor = function () {
        ...
        wpcf7_content_editor_properties.$content_placeholder_color_value.spectrum({
            ...
            showButtons: false,
            containerClassName:
                "rexbuilder-materialize-wrap block-placeholder-color-picker",
            show: function () {},
            move: function (color) {
                if(needToRemoveSpanData) {
                    needToRemoveSpanData = false;
        ...
        wpcf7_content_editor_properties.$content_placeholder_color_preview.on(
            "click",
            function () {
    ...
    var _linkPlaceholderHoverColorEditor = function () {
        ...
        wpcf7_content_editor_properties.$content_placeholder_hover_color_preview.on(
            "click",
            function () {
    ...
    var _linkDocumentListeners = function() {
        ...
        wpcf7_content_editor_properties.$content_button_hover_background_color_palette_buttons.on("click", function(event) {
            var color = $(event.currentTarget).find(".bg-palette-value").val();
    ...
    var _init = function() {
        ...
        wpcf7_content_editor_properties = {
            ...
            $content_select_color_after_selection_runtime: $container.find("#rex-wpcf7-select-text-color-after-selection-runtime"),
            $content_select_color_after_selection_preview: $container.find("#rex-wpcf7-select-text-color-after-selection-preview-icon"),

            $content_select_color_after_selection_palette_buttons: $self.find("#select-color-after-selection-palette .bg-palette-selector"),
            ...
            $content_button_hover_text_color_palette_buttons: $self.find("#button-hover-text-color-palette .bg-palette-selector"),
            ...
            $content_button_background_color_hover_runtime: $container.find("#rex-wpcf7-button-background-color-hover-runtime"),
            $content_button_background_color_hover_preview: $container.find("#rex-wpcf7-button-background-color-hover-preview-icon"),

            $content_button_hover_background_color_palette_buttons: $self.find("#button-hover-background-color-palette .bg-palette-selector"),
            ...
            $content_button_hover_border_color_palette_buttons: $self.find("#button-hover-border-color-palette .bg-palette-selector"),
        };
