var Rexlive_Block_Accordion = (function($) {
  ...
  var _saveData = function() {
    ...
    var html = {
      ...
      icon: "",
      complete: '<div class="rex-accordion' + ( true === state ? ' open' : ' close' ) + '"><div class="rex-accordion--toggle">' + tinyMCE_headerEditor.getContent() + '<span class="rex-accordion--toggle-icon"><i class="rex-accordion--close-icon l-svg-icons"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#Z001-Plus"></use></svg></i></span></div><div class="rex-accordion--content' + ( "" !== gallery_content ? " rex-accordion--gallery" : "" ) + '">' + ( "" !== gallery_content ? gallery_content : tinyMCE_contentEditor.getContent() ) + '</div></div>',
    };
