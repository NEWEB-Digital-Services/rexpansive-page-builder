 ...
 * @since 2.0.0
 */
var Block_Image_Positions_Setting = (function($) {
  "use strict";
  ...
  var _openBlockContentPositionModal = function(data) {
    _updatePosition(data.flexImgPosition);
  ...
  var _applyBlockPosition = function() {
    ...
    var data_position = {
      eventName: "rexlive:apply_flex_image_position_block",
      data_to_send: {
        position: {
          x: x,
          y: y
  ...
  var _init = function($container) {
    var $self = $container.find("#rex-block-image-position-setting");
    block_content_position_properties = {
      $self: $self,
      // block padding
      $positions: $self.find(".image-position"),
