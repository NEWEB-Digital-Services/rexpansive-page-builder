var Block_Video_Background_Modal = (function ($) {
    ...
    var _updateVideoModal = function (data) {
        ...
        if (data.type == "mp4") {
            ...
            video_background_properties.$audioMp4.prop('checked', data.audio.toString() == "true");
            _focusMp4();
    ...
    var _updateVideoBackground = function () {
        ...
        var videoMp4Data = {
            ...
            width: typeof video_background_properties.$linkMp4.attr("data-rex-video-bg-width") == "undefined" ? "" : video_background_properties.$linkMp4.attr("data-rex-video-bg-width"),
            height: typeof video_background_properties.$linkMp4.attr("data-rex-video-bg-height") == "undefined" ? "" : video_background_properties.$linkMp4.attr("data-rex-video-bg-height"),
        ...
        if ($selected.hasClass("youtube-insert-wrap")) {
            type = "youtube";
            audio = (true === video_background_properties.$audioYoutube.prop('checked') ? 'true' : 'false');
        } else if ($selected.hasClass("vimeo-insert-wrap")) {
            type = "vimeo";
            audio = (true === video_background_properties.$audioVimeo.prop('checked') ? 'true' : 'false');
        } else if ($selected.hasClass("mp4-insert-wrap")) {
            type = "mp4";
            audio = (true === video_background_properties.$audioMp4.prop('checked') ? 'true' : 'false');
        }
    ...
    var _linkDocumentListeners = function () {
        ...
        video_background_properties.$self.find(".set-video-audio-btn").click(function (e) {
            e.preventDefault();
            var $target = $(e.target);
    ...
    var _init = function ($container) {
        var $self = $container.find("#video-block-editor-wrapper");
