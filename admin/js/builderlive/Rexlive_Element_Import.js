	...
	*/
    ...
    var _linkDraggable = function() {
	    ...
	    Rexlive_Base_Settings.$document.on("dragstart", ".element-list li", function( event ) {
	      ...
	      // var insertingHTML =
	      //   '<div class="import-element" data-rex-element-id="' +
	      //   $(this).attr("data-rex-element-id") +
	      //   '"></div>';
	      tmpl.arg = "o";

	      var tmpl_obj = {
	        element_id: $(this).attr("data-rex-element-id")
	      };
	      var insertingHTML = tmpl("rexlive-tmpl-insert-element-loader", tmpl_obj);
	      if (isIE) {
