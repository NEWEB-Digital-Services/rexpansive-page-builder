 ...
 * @since 2.0.0
 */
var Rexlive_Overlay_Palette = (function($) {
  "use strict";
  ...
  var _listenEvents = function() {
    props.$add_color.on("click", function(e) {
      ...
      if( null !== props.$spicker ) {
        ...
        var overlay_ID = Rexbuilder_Util_Admin_Editor.createRandomID(4);
        ...
        Rexlive_Ajax_Calls.savePaletteOverlayColor(overlay_data);
    ...
    props.$container.on("click", ".palette-item__delete", function(e) {
      ...
      Rexlive_Ajax_Calls.deletePaletteOverlayColor(overlay_data);

      Rexlive_Overlay_Palette.deletePaletteItem(overlayEl);
    });
