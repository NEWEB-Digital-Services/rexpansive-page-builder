var Insert_Video_Modal = (function ($) {
    ...
    var _closeVideoModal = function () {
        Rexlive_Modals_Utils.closeModal(insert_video_properties.$self.parent('.rex-modal-wrap'));
    }
    ...
    var _linkDocumentListeners = function () {
        ...
        $(document).on("click", "#rex-insert-video-block-save", function (e) {
            ...
            var videoMp4Data;
            var audio;
            var $selected = insert_video_properties.$self.find(".video-insert-wrap.selected");
