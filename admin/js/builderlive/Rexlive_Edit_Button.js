...
var Button_Edit_Modal = (function ($) {
	...
	var _openChooseButtonEdit = function () {
		Rexlive_Modals_Utils.openModal(rex_edit_model_button_panel_properties.$self.parent('.rex-modal-wrap'));
	};

	var _closeChooseButtonEdit = function () {
		Rexlive_Modals_Utils.closeModal(rex_edit_model_button_panel_properties.$self.parent('.rex-modal-wrap'));
	};
		...
		rex_edit_model_button_panel_properties.$button.on('click', function (e) {
			...
			switch (optionSelected) {
				...
				case 'edit':
					...
					Rexlive_Modals_Utils.openModal(button_editor_properties.$self.parent('.rex-modal-wrap'));
					_staySynchronized();
					break;
				default:
					break;
			...
			for (i = 0; i < rexButtonsJSON.length; i++) {
				if (buttonID == rexButtonsJSON[i].rexID) {
					buttonData.text_color =
						typeof rexButtonsJSON[i].rules.element.text_color === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.text_color;
					buttonData.font_size =
						typeof rexButtonsJSON[i].rules.element.font_size === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.font_size;
					buttonData.background_color =
						typeof rexButtonsJSON[i].rules.element.background_color === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.background_color;
					buttonData.button_height =
						typeof rexButtonsJSON[i].rules.element.button_height === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.button_height;
					buttonData.button_width =
						typeof rexButtonsJSON[i].rules.element.button_width === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.button_width;
					buttonData.hover_color =
						typeof rexButtonsJSON[i].rules.hover.background_color === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.hover.background_color;
					buttonData.hover_text =
						typeof rexButtonsJSON[i].rules.hover.text_color === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.hover.text_color;
					buttonData.hover_border =
						typeof rexButtonsJSON[i].rules.hover.border_color === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.hover.border_color;
					buttonData.border_color =
						typeof rexButtonsJSON[i].rules.element.border_color === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.border_color;
					buttonData.border_width =
						typeof rexButtonsJSON[i].rules.element.border_width === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.border_width;
					buttonData.border_radius =
						typeof rexButtonsJSON[i].rules.element.border_radius === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.border_radius;
					buttonData.margin_top =
						typeof rexButtonsJSON[i].rules.element.margin_top === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.margin_top;
					buttonData.margin_bottom =
						typeof rexButtonsJSON[i].rules.element.margin_bottom === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.margin_bottom;
					buttonData.margin_right =
						typeof rexButtonsJSON[i].rules.element.margin_right === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.margin_right;
					buttonData.margin_left =
						typeof rexButtonsJSON[i].rules.element.margin_left === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.margin_left;
					buttonData.padding_top =
						typeof rexButtonsJSON[i].rules.element.padding_top === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.padding_top;
					buttonData.padding_bottom =
						typeof rexButtonsJSON[i].rules.element.padding_bottom === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.padding_bottom;
					buttonData.padding_right =
						typeof rexButtonsJSON[i].rules.element.padding_right === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.padding_right;
					buttonData.padding_left =
						typeof rexButtonsJSON[i].rules.element.padding_left === 'undefined'
							? ''
							: rexButtonsJSON[i].rules.element.padding_left;
	...
	var _createCSSbutton = function () {
		...
		currentTextSize = isNaN(parseInt(buttonData.font_size.replace('px', '')))
		...
		currentDimension = isNaN(parseInt(buttonData.button_height.replace('px', '')))
			? defaultButtonValues.dimensions.height
			: buttonData.button_height;
		buttonCSS += 'min-height: ' + currentDimension + ';';
		currentDimension = isNaN(parseInt(buttonData.button_width.replace('px', '')))
		...
		currentMargin = isNaN(parseInt(buttonData.margin_top.replace('px', '')))
			? defaultButtonValues.margins.top
			: buttonData.margin_top;
		buttonCSS += 'margin-top: ' + currentMargin + ';';
		currentMargin = isNaN(parseInt(buttonData.margin_right.replace('px', '')))
			? defaultButtonValues.margins.right
			: buttonData.margin_right;
		buttonCSS += 'margin-right: ' + currentMargin + ';';
		currentMargin = isNaN(parseInt(buttonData.margin_bottom.replace('px', '')))
			? defaultButtonValues.margins.bottom
			: buttonData.margin_bottom;
		buttonCSS += 'margin-bottom: ' + currentMargin + ';';
		currentMargin = isNaN(parseInt(buttonData.margin_left.replace('px', '')))
		...
		currentPadding = isNaN(parseInt(buttonData.padding_top.replace('px', '')))
			? defaultButtonValues.paddings.top
			: buttonData.padding_top;
		buttonCSS += 'padding-top: ' + currentPadding + ';';
		currentPadding = isNaN(parseInt(buttonData.padding_right.replace('px', '')))
			? defaultButtonValues.paddings.right
			: buttonData.padding_right;
		buttonCSS += 'padding-right: ' + currentPadding + ';';
		currentPadding = isNaN(parseInt(buttonData.padding_bottom.replace('px', '')))
			? defaultButtonValues.paddings.bottom
			: buttonData.padding_bottom;
		buttonCSS += 'padding-bottom: ' + currentPadding + ';';
		currentPadding = isNaN(parseInt(buttonData.padding_left.replace('px', '')))
		...
		currentBorderDimension = isNaN(parseInt(buttonData.border_width.replace('px', '')))
			? defaultButtonValues.border.width
			: buttonData.border_width;
		buttonCSS += 'border-width: ' + currentBorderDimension + ';';
		currentBorderDimension = isNaN(parseInt(buttonData.border_radius.replace('px', '')))
