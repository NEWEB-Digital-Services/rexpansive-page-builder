...
(function (factory) {
    ...
    ; (function ($, window, document, Util, undefined) {
        ...
        Images.prototype.add = function () {
            ...
            if (this.options.file_frame) {
                this.options.file_frame.open();
                return;
            }

            this.options.file_frame = wp.media.frames.file_frame = wp.media({
            ...
            this.options.file_frame.on('select', function () {
                var attachment = that.options.file_frame.state().get('selection').first().toJSON();
                ...
                $(that.templates['src/js/templates/images-image.hbs']({
                    img: img,
                    progress: false,
                })).appendTo($place);
