;(function(window, factory) {
	'use strict';
	window.RevealOpacityOnScroll = factory(window);
	...
	function RevealOpacityOnScroll() {
		this.element = null;
		this.launched = false;
	...
	function handleAnimation() {
		...
		// var elScrollTop = this.elOffsetTop;
		var elScrollBottom = elScrollTop + this.elBoundingInfo.height;

		var c = ( elScrollBottom - elScrollTop ) * 0;
		var d = ( elScrollBottom - elScrollTop ) * 0.2;
		var x = windowScrollTop + ( windowInnerHeight * this.options.offset );

		var y = ( x - ( elScrollTop + c ) ) / ( ( elScrollBottom + d ) - ( elScrollTop + c ) );
		this.element.style.opacity = y;
	}
