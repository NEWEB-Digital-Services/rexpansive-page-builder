...
(function (factory) {
    ...
    ; (function ($, window, document, Util, undefined) {
        ...
        /** Default values */
        var pluginName = 'mediumInsert',
            addonName = 'WordpressImages', // first char is uppercase
            defaults = {
                label: '<span class="fa fa-camera"></span>',
                deleteMethod: 'POST',
                deleteScript: 'delete.php',
        ...
        function WordpressImages(el, options) {
            this.el = el;
            this.$el = $(el);
            this.$currentImage = null;
            this.templates = window.MediumInsert.Templates;
        ...
        WordpressImages.prototype.init = function () {
            var $images = this.$el.find('.medium-insert-images');
        ...
        WordpressImages.prototype.events = function () {
            $(document).on("rexlive:insertImagesInBlock", $.proxy(this, 'uploadDone'));
        ...
        WordpressImages.prototype.backwardsCompatibility = function () {
            this.$el.find('.mediumInsert')
                .removeClass('mediumInsert')
                .addClass('medium-insert-images');
        ...
        WordpressImages.prototype.editorSerialize = function () {
            var data = this._serializePreImages();
        ...
        WordpressImages.prototype.add = function () {
            var $place = this.$el.find('.medium-insert-active');
            this.core.hideButtons();
            ...
            var data = {
                returnEventName: "rexlive:insertImagesInBlock",
        ...
        WordpressImages.prototype.uploadDone = function (e) {
            //adding images gained from media library
            var $place = this.$el.find('.medium-insert-active');
            ...
            for (i = 0; i < media.length; i++) {
                var urlImage = media[i].display_info.src;
                var altImage = media[i].display_info.alt;
                var $figureEl = $(document.createElement("figure"));
                var $imgEl = $(document.createElement("img"));

                $figureEl.attr("contenteditable", "false");
                $imgEl.attr("src", urlImage);
                $imgEl.attr("alt", altImage);

                $imgEl.appendTo($figureEl[0]);
                $figureEl.appendTo($place[0]);
            }

            $.proxy(this, 'showImage', "", data)();
        ...
        WordpressImages.prototype.showImage = function (img, data) {
            var $place = this.$el.find('.medium-insert-active'),
                domImage,
                that;
        ...
        WordpressImages.prototype.getDOMImage = function () {
            return new window.Image();
        };
        ...
        WordpressImages.prototype.selectImage = function (e) {
            var that = this,
                $image;
        ...
        WordpressImages.prototype.unselectImage = function (e) {
            var $el = $(e.target),
                $image = this.$el.find('.medium-insert-image-active');
        ...
        WordpressImages.prototype.removeImage = function (e) {
            var images = [],
                $selectedImage = this.$el.find('.medium-insert-image-active'),
                $parent, $empty, selection, range, current, caretPosition, $current, $sibling, selectedHtml, i;
        ...
        WordpressImages.prototype.deleteFile = function (file, $el) {
            // only take action if there is a truthy value
            if (this.options.deleteScript) {
                // try to run it as a callback
                if (typeof this.options.deleteScript === 'function') {
        ...
        WordpressImages.prototype.addToolbar = function () {
            var $image = this.$el.find('.medium-insert-image-active'),
                $p = $image.closest('.medium-insert-images'),
                active = false,
                mediumEditor = this.core.getEditor(),
        ...
        WordpressImages.prototype.autoRepositionToolbars = function () {
            setTimeout(function () {
                this.repositionToolbars();
                this.repositionToolbars();
            }.bind(this), 0);
        ...
        WordpressImages.prototype.repositionToolbars = function () {
            var $toolbar = $('.medium-insert-images-toolbar'),
                $toolbar2 = $('.medium-insert-images-toolbar2'),
                $image = this.$el.find('.medium-insert-image-active'),
                elementsContainer = this.core.getEditor().options.elementsContainer,
        ...
        WordpressImages.prototype.toolbarAction = function (e) {
            var that = this,
                $button, $li, $ul, $lis, $p;
        ...
        WordpressImages.prototype.toolbar2Action = function (e) {
            var $button, callback;
        ...
        WordpressImages.prototype.sorting = function () {
            $.proxy(this.options.sorting, this)();
        };
        ...
        $.fn[pluginName + addonName] = function (options) {
            return this.each(function () {
                if (!$.data(this, 'plugin_' + pluginName + addonName)) {
                    $.data(this, 'plugin_' + pluginName + addonName, new WordpressImages(this, options));
                }
            });
        };
