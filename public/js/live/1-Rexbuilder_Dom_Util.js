var Rexbuilder_Dom_Util = (function($) {
  ...
  var _updateImageSection = function($section, $sectionData, data) {
    ...
    Rexbuilder_Live_Utilities.activeAddSection( $section );
  };
  ...
  var _updateImageBlock = function($itemContent, $elemData, data) {
    ...
    if ( Rexbuilder_Util.fast_load && ! Rexbuilder_Util.editorMode ) {
      $itemContent.find('.rex-image-wrapper').attr('data-src', data.urlImage);
    } else {
  ...
  var _updateVideos = function($target, videoOptions) {
    ...
    if (targetType == "section") {
      ...
      Rexbuilder_Live_Utilities.activeAddSection( $target );
