var Rexbuilder_Rexelement = (function ($) {
  ...
  function generateElementData($elementWrapper, getAllData) {
    ...
    // Options different
    elementData.wpcf7_data.options_different = _scanOptionsDifferent(elementData.element_target.element_id, elementData.wpcf7_data.options_different);  // Only builder
