  ...
  function updateColumnContent(data) {
    ...
    if (inputType != "submit") {
        ...
        if (inputType == "file") {
            ...
            updateColumnContentHoverRule(formID, row, column, cssSelector + " label", "background-color", buttonBackgroundColorHover);
            updateColumnContentHoverRule(formID, row, column, cssSelector + " label", "border-color", buttonBorderColorHover);
        }
    ...
    var columnContentData = {
      ...
      if( $formColumn.find('.wpcf7-form-control').length > 0 ) {
          ...
          if ( null === columnContentData.field_class ) {
              columnContentData.field_class = /[a-z]+\-[0-9]+/.exec($formColumn.find('.wpcf7-form-control-wrap').get(0).classList);

              if ( null === columnContentData.field_class ) {
                columnContentData.field_class = /[a-z]+\-[0-9]+/.exec($formColumn.find('[type=checkbox]').get(0).classList)[0];
              } else {
