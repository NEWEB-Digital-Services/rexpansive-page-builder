var RexSlider = (function ($) {
  ...
  var _initSlider = function ($sliderWrap) {
    ...
    var settings = {
      ...
      friction: 0.30,
      wrapAround: _plugin_frontend_settings.slider.wrapAround,
      // adaptiveHeight: true,
    ...
    settings.wrapAround = ('undefined' != typeof $sliderWrap.attr('data-wrap-around') ? JSON.parse($sliderWrap.attr('data-wrap-around')) : settings.wrapAround);
