; (function ($) {
    ...
    $(function () {
         ...
         */
        $(document).on('gridGalleryEditorReady', function (e) {
            var gallery = e.gallery;
            var button = document.createElement('button');
            var div = document.createElement('div');
            var iElem = document.createElement('i');
            
            //console.log(gallery.properties.gridstackInstanceID);
            $(div).append(button);
            $(button).append(iElem);
            gallery.$element.parents('.rexpansive_section').prepend(div);
            $(div).addClass('toolBox');
            $(iElem).addClass('material-icons');

            $(button).attr({
                'class': 'tool-button btn-floating builder-section-config tooltipped waves-effect waves-light',
                'data-tooltip': 'Row settings',
                'data-position': 'bottom',
                'data-section_id': '',
            });
            $(button).on('click', function(){
                //console.log('button clicked');
                console.log(gallery.properties.sectionNumber);
                $('#backresponsive-set-save').attr('data-section_id', gallery.properties.sectionNumber);
                $('#backresponsive-set-reset').attr('data-section_id', gallery.properties.sectionNumber);
