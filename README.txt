 ...
 * Fixed: PHP warnings when plugin fails to load updates information
 * Fixed: Bug on ordering new sections
...
* Fixed: Row cloning with a RexButton
* Fixed: Image size for section background
